...
/// Kartu ringkas untuk satu laporan (dipakai di Home, Search, dan My Reports
/// supaya tampilannya konsisten di semua tab).
class ActivityCard extends StatelessWidget {
  const ActivityCard({super.key, required this.report, required this.timeAgoText, this.onTap});
  final Report report;
