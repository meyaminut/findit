      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            const Text('Report Found Item', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
          ],
        ),
        actions: [
          Padding(
        ...
        child: ListView(
          ...
          children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text('Good Samaritan Shield', style: theme.textTheme.titleSmall?.copyWith(color: Colors.orange.shade800, fontWeight: FontWeight.bold)),
            ...
            Row(
              ...
              children: [
                const _FieldLabel(label: 'Item Photography', required: true),
                Container(
            ...
            _photo == null
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    CircleAvatar(radius: 22, backgroundColor: navy.withValues(alpha: 0.08), child: Icon(Icons.camera_alt_outlined, color: navy)),
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: Row(
                      children: [
                        _PhotoIconButton(icon: Icons.refresh, label: 'Retake', onTap: _takePhoto),
                        const SizedBox(width: 8),
                        _PhotoIconButton(icon: Icons.delete_outline, color: Colors.red, onTap: _removePhoto),
                      ],
                    ),
                  ),
                ],
            ...
            const Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                _FieldLabel(label: 'Item Title', required: true),
            ...
            const _FieldLabel(label: 'Where Did You Find It?', required: true),
            const SizedBox(height: 8),
            TextFormField(
            ...
            const _FieldLabel(label: 'Safe Custody & Possession', required: true),
            const SizedBox(height: 8),
            _CustodyOption(
            ...
            const _FieldLabel(label: 'Description & Condition Details'),
            const SizedBox(height: 8),
            TextFormField(
            ...
            // --- Date & Time Found ---
            const _FieldLabel(label: 'Date & Time Found', required: true),
            const SizedBox(height: 8),
            InkWell(
              onTap: _pickDateTime,
...
class _PhotoIconButton extends StatelessWidget {
  const _PhotoIconButton({required this.icon, this.label, this.color, required this.onTap});
  final IconData icon;
  final String? label;
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            // Custom radio dot (menghindari deprecated Radio.groupValue/onChanged)
            Container(
              width: 20,
              height: 20,
              decoration: BoxDecoration(
